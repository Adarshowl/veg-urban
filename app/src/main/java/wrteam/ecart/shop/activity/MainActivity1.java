...
public class MainActivity1 extends AppCompatActivity implements PaymentResultListener, PaytmPaymentTransactionCallback {
...
//                        break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.toolbar_profile) {
            MainActivity1.fm.beginTransaction().add(R.id.container, new DrawerFragment()).addToBackStack(null).commit();
        } else if (id == R.id.toolbar_cart) {
            MainActivity1.fm.beginTransaction().add(R.id.container, new CartFragment()).addToBackStack(null).commit();
            ...
            MainActivity1.fm.beginTransaction().add(R.id.container, fragment).addToBackStack(null).commit();
