...
public class ProductDetailFragment extends Fragment {
    ...
    TextView showDiscount, tvDescription, tvMfg, tvMadeIn, tvProductName, tvQuantity, tvPrice, tvOriginalPrice, tvMeasurement, tvStatus, tvTitleMadeIn, tvTitleMfg, tvTimer, tvTimerTitle;
    ...
    LinearLayout lytShare, lytSave, lytSimilar, lyt_cod;
    int count;
    View root;
    int variantPosition;
    String from, id;
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        tvDescription = root.findViewById(R.id.tv_des);
        ...
        lyt_cod = root.findViewById(R.id.lyt_cod);
        ...
        lottieAnimationView.setAnimation("heart_1.json");
...
//                            Log.d(TAG, "GetProductDetail: " + jsonArray.getJSONObject(i).toString());
                        }
    ...
    void SetProductDetails(final Product product) {
        try {
            ...
            if (product.getIs_cod_allowed().equalsIgnoreCase("1")) {
                imgReturnable.setImageResource(R.drawable.ic_cod);
//                tvReturnable.setText(Integer.parseInt(session.getData(Constant.max_product_return_days)) + " Days Returnable.");
                tvReturnable.setText("C.O.D. Available");
            } else {
                imgReturnable.setImageResource(R.drawable.ic_cod);
                tvReturnable.setText("Not Returnable.");
                lyt_cod.setVisibility(View.GONE);
            } // 15 feb 2023
...
//        Constant.TOOLBAR_TITLE = getString(R.string.app_name);
    ...
    public void SetSelectedData(Variants variants) {
        Log.d(TAG, "SetSelectedData: " + variants.getDiscounted_price() + " " + variants.getPrice());
...
//            lytTimer.setVisibility(View.VISIBLE); commented on 23 feb
...
//            Log.d(TAG, "details onBindViewHolder: timediff" + strCurrentDate + " *** " + strStartDate + " *** " + strEndDate + " *** " + timeDiff);


            if (timeDiff < 0) {
//                Log.d(TAG, "SetSelectedData timediff details: 11");
...
//                Log.d(TAG, "SetSelectedData timediff details: 22");
...
//                Log.d(TAG, "SetSelectedData timediff details: 33");
...
//    @SuppressLint({"DefaultLocale", "SetTextI18n", "SimpleDateFormat"})  // commented on 3 march to remove timer
//    public void StartTimer(Activity activity, Variants variants) {
//
...
/**
 * Server key : AAAA6olhDx0:APA91bHHNf3E0eGZuAQJTu0eesvdkh4aaju66oTPSxPuQuVDZQ4zJfjD6sXmbYl9EHgKyaoUo_CTR8T0lmgJigdn4Q3Q6IjZPAehZvlUm9kFGdlyeERxSfC-7T6cBYspeaMrBBImUVMh
 * Sender ID : 1007327186717
 */