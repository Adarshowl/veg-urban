...
import static wrteam.ecart.shop.activity.MainActivity.counts;
...
//            assert Date1 != null;
            ...
            Log.d(TAG, "dayBetween: exception" + e.getMessage());
        }
        return 0;
    }
    ...
    public static void RequestToVolley(final VolleyCallback callback, final Activity activity, final String url, final Map<String, String> params, final boolean isProgress) {
        ...
        if (ApiConfig.isConnected(activity)) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
                ...
                Log.d(TAG, "RequestToVolley: response -> " + response);
                if (isProgress) progressDisplay.hideProgress();
                    ...
                    error -> {
                        ...
                        Log.d(TAG, "RequestToVolley: message -> " + message);
...
//                    params1.put(Constant.AUTHORIZATION, "Bearer " + createJWT("eKart", "eKart Authentication"));
                    ...
                    params1.put(Constant.AUTHORIZATION, "Bearer " + Constant.JWT_KEY);
                    Log.d(TAG, "RequestToVolley: params1 getHeaders -> " + params1.get(Constant.AUTHORIZATION));
                ...
                protected Map<String, String> getParams() {
                    ...
                    Log.d(TAG, "RequestToVolley: params1 getParams -> " + params.get(Constant.AccessKey));
